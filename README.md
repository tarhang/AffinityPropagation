# AffinityPropagation
Implementation of the clustering algorithm Affinity Propagation using Java. Affinity propagaion is a clustering algorithm that finds a set of exemplar data points, and the corresponding clusters, based on a similarity measure between pairs of data points.
